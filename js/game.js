const canvas = document.getElementById('gameCanvas');
    ...
    function drawZombies() {
      ...
      zombies.forEach(z => {
        const isFromLeft = z.x < canvas.width / 2; // Determina la direzione di arrivo
    ...
    function stopGame() {
      ...
      clearInterval(gameInterval); // Ferma lo spawn degli zombie
      cancelAnimationFrame(animationFrame); // Ferma il ciclo di rendering
      resetGame(); // Resetta le variabili del gioco
    }
